...
define("MESSAGE_GCM_UPDATE_SUCCESS", "Users gcm-id successfully updated");
define("MESSAGE_GCM_UPDATE_FAILED", "Failed to update users gcm-id");
...
define("MESSAGE_USER_REAL_NAME_EMPTY", "Users real name field was empty");
define("MESSAGE_USER_REAL_NAME_BAD_LENGTH", "Users name cannot be shorter than 2 or longer than 64 characters").
define("MESSAGE_USER_REAL_NAME_INVALID", "Username does not fit the name scheme: only a-Z are allowed, 2 to 64 characters");
define("MESSAGE_ACCESS_DENIED", "Access denied. Please login");
...
define("MESSAGE_LOGIN_FAILED", "Login failed."); // The "login failed"-message is a security improved feedback that doesn't show a potential attacker if the user exists or not
